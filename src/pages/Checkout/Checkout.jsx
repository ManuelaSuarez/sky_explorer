            ...
            <div className="passenger-info-form">
              ...
              <div className="option-buttons gender-buttons">
                <button
                  type="button"
                  className={
                    formData.sexo === "Masculino" ? "option-selected" : ""
                  }
                  onClick={() =>
                ...
                <button
                  type="button"
                  className={
                    formData.sexo === "Femenino" ? "option-selected" : ""
                  }
              ...
              <div className="option-buttons class-buttons">
                <button
                  type="button"
                  className={
                    formData.clase === "Economica" ? "option-selected" : ""
                  }
                  onClick={() =>
                    setFormData({ ...formData, clase: "Economica" })
                  }
                >
                  Economica
                </button>
                ...
                <button
                  type="button"
                  className={
                    formData.clase === "Primera clase" ? "option-selected" : ""
                  }
                  onClick={() =>
                    setFormData({ ...formData, clase: "Primera clase" })
                  }
                >
                  Primera clase
                </button>
            ...
            <div className="info-card payment-details">
              ...
              <div className="detail-row">
                ...
                <span className="price">
                  $ {paymentDetails.flightCost.toLocaleString()}
                </span>
              </div>
              ...
              <div className="detail-row">
                ...
                <span className="price">
                  $ {paymentDetails.classSurcharge.toLocaleString()}
                </span>
              </div>
            ...
            <div className="info-card flight-details">
              <div className="flight-details-title">
                ...
                <div className="route-line">
                  ...
                  <div className="route-line">
                    <strong>{flightDetails.returnOrigin}</strong> -{" "}
                    <strong>{flightDetails.returnDestination}</strong>
                  </div>
